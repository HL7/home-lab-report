...
* identifier MS
* identifier ^short = "At-Home Test Specimen identifier. {Unique ID assigned to every test by app manufacturer} If converting FHIR to V2, must be 100 characters or less. V2: SPM-2.2.1, SPM-2.2.3, SPM-2.2.4"
