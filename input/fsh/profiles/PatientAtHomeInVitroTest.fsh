...
* identifier ^short = "An identifier for this patient: the value that is unique within the system. Unique ID assigned to patient by App provider. If converting FHIR to V2, must be 100 characters or less. V2: PID-3.1"
* identifier.system ^short = "See 'Obtaining App Specific Identifiers' (see Guidance->Getting Started for details)"
