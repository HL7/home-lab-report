...
* extension[vendorOrganization] ^short = "Source software vendor organization"
* extension[vendorOrganization] ^definition = "Source software vendor organization"
...
* extension[softwareBinaryID] ^short = "Source software binary ID"
* extension[softwareBinaryID] ^definition = "Source software vendor organization"
...
* extension[softwareInstallDate] ^short = "Source software install date"
* extension[softwareInstallDate] ^definition = "Source software vendor organization"
